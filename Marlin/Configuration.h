...
#define STRING_CONFIG_H_AUTHOR "(JGR, Ender-3 Pro)" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 148.32
  #define DEFAULT_bedKi 28.09
  #define DEFAULT_bedKd 522.09
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, -9.5, -2.850 }
